		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Qual produto?">
					<span class="mr-4"><input name="produto" v-model="produto" type="radio" value="web"> Web</span>
					<span class="mr-4"><input name="produto" v-model="produto" type="radio" value="mobile"> Mobile</span>
					<span><input name="produto" v-model="produto" type="radio" value="outro"> Outro</span>
				</Rotulo>
